...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Profile.confirmation_token'
        db.delete_column('users_profile', 'confirmation_token')


    def backwards(self, orm):
        
        # Adding field 'Profile.confirmation_token'
        db.add_column('users_profile', 'confirmation_token', self.gf('django.db.models.fields.CharField')(default='', max_length=40), keep_default=False)
