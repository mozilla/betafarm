...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('feeds_entry', 'link')


    def backwards(self, orm):
        
        # Adding field 'Entry.link'
        db.add_column('feeds_entry', 'link', self.gf('django.db.models.fields.URLField')(default=None, max_length=200), keep_default=False)
    ...
    models = {
        ...
        'feeds.entry': {
            ...
            'published': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 15, 10, 55, 17, 68103)'}),
