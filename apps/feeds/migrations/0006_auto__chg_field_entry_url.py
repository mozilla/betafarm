...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('feeds_entry', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))


    def backwards(self, orm):
        
        # Changing field 'Entry.url'
        db.alter_column('feeds_entry', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
    ...
    models = {
        ...
        'feeds.entry': {
            ...
            'published': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 15, 10, 56, 51, 608233)'}),
