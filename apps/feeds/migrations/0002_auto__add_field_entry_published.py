...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('feeds_entry', 'published', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 8, 4, 6, 35, 29, 445358)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Entry.published'
        db.delete_column('feeds_entry', 'published')
    ...
    models = {
        ...
        'feeds.entry': {
            ...
            'published': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 4, 6, 35, 29, 445358)'}),
