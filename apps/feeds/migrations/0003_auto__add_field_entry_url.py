...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('feeds_entry', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Entry.url'
        db.delete_column('feeds_entry', 'url')
    ...
    models = {
        ...
        'feeds.entry': {
            ...
            'published': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 15, 10, 52, 22, 540975)'}),
