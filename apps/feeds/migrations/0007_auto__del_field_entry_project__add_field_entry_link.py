...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('feeds_entry', 'project_id')

        # Adding field 'Entry.link'
        db.add_column('feeds_entry', 'link', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['projects.Link']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Entry.project'
        db.add_column('feeds_entry', 'project', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['projects.Project']), keep_default=False)

        # Deleting field 'Entry.link'
        db.delete_column('feeds_entry', 'link_id')
    ...
    models = {
        ...
        'feeds.entry': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['projects.Link']"}),
            'published': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 15, 10, 57, 47, 723986)'}),
        ...
        'projects.project': {
            ...
            'followers': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "u'projects_following'", 'symmetrical': 'False', 'to': "orm['users.Profile']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
