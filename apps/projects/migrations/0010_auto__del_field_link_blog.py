...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Link.blog'
        db.delete_column('projects_link', 'blog')


    def backwards(self, orm):
        
        # Adding field 'Link.blog'
        db.add_column('projects_link', 'blog', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
