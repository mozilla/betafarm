...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('projects_link', 'project', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['projects.Project']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('projects_link', 'project_id')
