...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.inactive'
        db.add_column('projects_project', 'inactive', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.inactive'
        db.delete_column('projects_project', 'inactive')
